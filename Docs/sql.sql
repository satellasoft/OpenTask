...
-- -----------------------------------------------------
-- Schema satellas_triquantic_collab
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema satellas_triquantic_collab
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `satellas_triquantic_collab` DEFAULT CHARACTER SET utf8 ;
USE `satellas_triquantic_collab` ;

-- -----------------------------------------------------
-- Table `satellas_triquantic_collab`.`user`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `satellas_triquantic_collab`.`user` (
...
-- -----------------------------------------------------
-- Table `satellas_triquantic_collab`.`project`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `satellas_triquantic_collab`.`project` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `satellas_triquantic_collab`.`task`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `satellas_triquantic_collab`.`task` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_task_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `satellas_triquantic_collab`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_task_project1`
    FOREIGN KEY (`project_id`)
    REFERENCES `satellas_triquantic_collab`.`project` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `satellas_triquantic_collab`.`file`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `satellas_triquantic_collab`.`file` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_file_task1`
    FOREIGN KEY (`task_id`)
    REFERENCES `satellas_triquantic_collab`.`task` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `satellas_triquantic_collab`.`forum`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `satellas_triquantic_collab`.`forum` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `satellas_triquantic_collab`.`forum_comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `satellas_triquantic_collab`.`forum_comment` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_forum_comment_forum1`
    ...
    REFERENCES `satellas_triquantic_collab`.`forum` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `satellas_triquantic_collab`.`user_project`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `satellas_triquantic_collab`.`user_project` (
  `user_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `satellas_triquantic_collab`.`note`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `satellas_triquantic_collab`.`note` (
  `id` INT NOT NULL AUTO_INCREMENT,
