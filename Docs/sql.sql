...
-- Schema collab
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `collab` DEFAULT CHARACTER SET utf8 ;
USE `collab` ;
...
-- -----------------------------------------------------
-- Table `collab`.`project`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `collab`.`project` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- Table `collab`.`task`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `collab`.`task` (
  `id` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_task_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `collab`.`user` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_task_project1`
    FOREIGN KEY (`project_id`)
    REFERENCES `collab`.`project` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `collab`.`file`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `collab`.`file` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `fl_title` VARCHAR(100) NOT NULL,
  `fl_directory` VARCHAR(150) NOT NULL,
  `type` INT(1) NOT NULL DEFAULT 1 COMMENT '1 = img | 2 = file',
...
-- Table `collab`.`forum`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `collab`.`forum` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `collab`.`forum_comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `collab`.`forum_comment` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `collab`.`user_project`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `collab`.`user_project` (
  `user_id` INT NOT NULL,
...
-- Table `collab`.`note`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `collab`.`note` (
  `id` INT NOT NULL AUTO_INCREMENT,
