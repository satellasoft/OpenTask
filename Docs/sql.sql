...
-- -----------------------------------------------------
-- Table `opentask`.`task_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `opentask`.`task_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `tc_name` VARCHAR(100) NOT NULL,
  `tc_register` DATETIME NOT NULL,
  `project_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_task_category_project1_idx` (`project_id` ASC),
  CONSTRAINT `fk_task_category_project1`
...
CREATE TABLE IF NOT EXISTS `opentask`.`task` (
  ...
  INDEX `fk_task_task_category1_idx` (`task_category_id` ASC),
  ...
  CONSTRAINT `fk_task_task_category1`
    ...
    REFERENCES `opentask`.`task_category` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
