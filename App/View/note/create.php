<div class="card border-info">
  ...
  <div class="card-body">
    ...
    <form action="<?=BASE?>note/store" method="post" onsubmit="return validateNote(false);">
      <div class="row">
        <div class="col-md-6">
          <label for="txtTitle">Título da nota</label>
          <input type="text" name="txtTitle" id="txtTitle" class="form-control" placeholder="Note title">
        </div>
        ...
        <div class="col-md-2">
          ...
          <select class="form-control" name="slColor" id="slColor">
            ...
            <option value="65e06d" style="background-color: #65e06d;">Verde</option>
            <option value="65b9e0" style="background-color: #65b9e0;">Azul</option>
            <option value="9a65e0" style="background-color: #9a65e0;">Roxo</option>
            <option value="e065ce" style="background-color: #e065ce;">Rosa 1</option>
            <option value="e06594" style="background-color: #e06594;">Rosa 2</option>
          </select>
        </div>
